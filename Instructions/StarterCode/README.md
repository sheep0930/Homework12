...
* This line in the Procfile tells the gunicorn web server that `pet_pals` is the name of the folder that contains your app as a python package (i.e. the name of the folder with the `__init__.py` file in it).
...
* After adding the database, you can open the application using `heroku open` from the terminal.
